...
def lutar(atacante, defensor):
    atacante = model_comecar_por_aqui.heroi_pronto_por_nome(atacante)
    defensor = model_comecar_por_aqui.heroi_pronto_por_nome(defensor)
    model_comecar_por_aqui.luta(atacante, defensor)
    return 'Fim', 200
