...
class TestStringMethods(unittest.TestCase):
    ...
    def test_004_adiciona_e_deleta(self):
        r_reset = requests.post('http://localhost:5003/reseta')
        self.assertEqual(r_reset.status_code,200)
        requests.post('http://localhost:5003/pessoas',json={'nome':'cicero','id':29})
        requests.post('http://localhost:5003/pessoas',json={'nome':'lucas','id':28})
        r_lista = requests.get('http://localhost:5003/pessoas')
        self.assertEqual(len(r_lista.json()),2)
        requests.delete('http://localhost:5003/pessoas/28')
        r_lista = requests.get('http://localhost:5003/pessoas')
    ...
    def test_005_edita(self):
        ...
        self.assertEqual(r_reset.status_code,200)
        requests.post('http://localhost:5003/pessoas',json={'nome':'lucas','id':28})
        r_antes = requests.get('http://localhost:5003/pessoas/28')
        self.assertEqual(r_antes.json()['nome'],'lucas')
        requests.put('http://localhost:5003/pessoas/28', json={'nome':'lucas mendes'})
        r_depois = requests.get('http://localhost:5003/pessoas/28')
        self.assertEqual(r_depois.json()['nome'],'lucas mendes')

    def test_006_id_inexistente(self):
        r_reset = requests.post('http://localhost:5003/reseta')
        self.assertEqual(r_reset.status_code,200)
        r = requests.put('http://localhost:5003/pessoas/15',json={'nome':'bowser','id':15})
        self.assertEqual(r.status_code,400)
        self.assertEqual(r.json()['erro'],'pessoa nao encontrado')
        r = requests.get('http://localhost:5003/pessoas/15')
        self.assertEqual(r.status_code,400)
        self.assertEqual(r.json()['erro'],'pessoa nao encontrado')
        r = requests.delete('http://localhost:5003/pessoas/15')
        self.assertEqual(r.status_code,400)
        self.assertEqual(r.json()['erro'],'pessoa nao encontrado')
    ...
    def test_007_criar_com_id_ja_existente(self):
        r_reset = requests.post('http://localhost:5003/reseta')
        self.assertEqual(r_reset.status_code,200)
        r = requests.post('http://localhost:5003/pessoas',json={'nome':'bond','id':7})
        self.assertEqual(r.status_code,200)
        r = requests.post('http://localhost:5003/pessoas',json={'nome':'james','id':7})
        self.assertEqual(r.status_code,400)
    ...
    def test_008_post_ou_put_sem_nome(self):
        r_reset = requests.post('http://localhost:5003/reseta')
        self.assertEqual(r_reset.status_code,200)
        r = requests.post('http://localhost:5003/pessoas',json={'id':8})
        self.assertEqual(r.status_code,400)
        self.assertEqual(r.json()['erro'],'pessoa sem nome')
        r = requests.post('http://localhost:5003/pessoas',json={'nome':'maximus','id':7})
        self.assertEqual(r.status_code,200)
        r = requests.put('http://localhost:5003/pessoas/7',json={'id':7})
        self.assertEqual(r.status_code,400)
        self.assertEqual(r.json()['erro'],'pessoa sem nome')
   
    def test_009_interesse_com_pessoas_validas(self):
        r_reset = requests.post('http://localhost:5003/reseta')
    ...
    def test_011_match_perdido(self):
        r_reset = requests.post('http://localhost:5003/reseta')
        self.assertEqual(r_reset.status_code,200)
        r = requests.get('http://localhost:5003/matches/9')
        self.assertEqual(r.status_code,404)
    ...
    def test_012_match_incompativel(self):
        r_reset = requests.post('http://localhost:5003/reseta')
        self.assertEqual(r_reset.status_code,200)
        r = requests.get('http://localhost:5003/matches/9')
        self.assertEqual(r.status_code,404)
    ...
    def test_013_match_compativel(self):
        r_reset = requests.post('http://localhost:5003/reseta')
        self.assertEqual(r_reset.status_code,200)
        r = requests.get('http://localhost:5003/matches/9')
        self.assertEqual(r.status_code,404)
