...
class TestStringMethods(unittest.TestCase):
    ...
    def test_000_todas_questoes(self):
    ...
    def test_001_questoes_presentes(self):
    ...
    def test_005_cria_questao(self):
        q1 = {
    ...
    def test_007_questao_inexistente(self):
        r = requests.post(url+'reseta')
        self.assertEqual(r.status_code,200)
        r = requests.get(url+'questao/1')
        self.assertEqual(r.status_code,200)
    ...
    def test_008_questao_incompleta(self):
        r = requests.post(url+'reseta')
        self.assertEqual(r.status_code,200)
    ...
    def test_009_questao_adiciona_alternativas_erradas(self):
        r = requests.post(url+'reseta')
        self.assertEqual(r.status_code,200)
    ...
    def test_010_adiciona_alternativas_erradas_404(self):
        r = requests.post(url+'reseta')
        self.assertEqual(r.status_code,200)
    ...
    def test_011_questao_adiciona_alternativas_corretas(self):
        r = requests.post(url+'reseta')
        self.assertEqual(r.status_code,200)
    ...
    def test_012_adiciona_alternativas_corretas_404(self):
        r = requests.post(url+'reseta')
        self.assertEqual(r.status_code,200)
